...
namespace ChatGPTWrapper {
    ...
    public class Chat
    {
        ...
        public Chat(string initialPrompt, string initialQuestion, string initialAnswer) 
        {
            _initialPrompt = initialPrompt;
            Message systemMessage = new Message("system", initialPrompt);
            _currentChat.Add(systemMessage);

            Message firstQuestion = new Message("user", initialQuestion);
            _currentChat.Add(firstQuestion);

            Message firstAnswer = new Message("assistant", initialAnswer);
            _currentChat.Add(firstAnswer);
        }
